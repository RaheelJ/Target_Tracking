...
File1_Data = csvread('Output/Coordinated_Leader_States.csv', 1);
Time = File1_Data(:, 1);
Heading_Angle = File1_Data(:, 4);
Longitude = File1_Data(:, 3);
Latitude = File1_Data(:, 2);

File2_Data = csvread('Output/Coordinated_Follower_States.csv', 1);
Time_F = File2_Data(:, 1);
Longitude_1 = File2_Data(:, 3);
Latitude_1 = File2_Data(:, 2);
Heading_Angle = File1_Data(:, 4);
Longitude_2 = File2_Data(:, 5);
Latitude_2 = File2_Data(:, 4);
Longitude_3 = File2_Data(:, 7);
Latitude_3 = File2_Data(:, 6);
Longitude_4 = File2_Data(:, 9);
Latitude_4 = File2_Data(:, 8);
% T_Meas = File2_Data(:, 1); 
% T_X = File2_Data(:, 2);
% T_Y = File2_Data(:, 3);
% T_Z = File2_Data(:, 4);
...
geoplot(Latitude, Longitude, 'r', Latitude_1, Longitude_1, 'k', Latitude_2, Longitude_2, 'm', Latitude_3, Longitude_3, 'g', Latitude_4, Longitude_4, 'c', T_Latitude, T_Longitude, 'b');
...
% ylabel('Distance (m)');
% xlabel('Time (s)');
% title('Relative Position in Longitudinal Plane');
% % Create legend
